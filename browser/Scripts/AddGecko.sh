...
# Fall back to ad-hoc signing ("-") when the build provides no real signing
# identity (unsigned CI builds). The codesign CLI accepts "-" even though
# Xcode's own signing steps refuse it for device SDKs.
